...
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "classes", "com" ,"subadquirencia", "client.cfg"))
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "classes", "com" ,"subadquirencia", "GXcfg.class"))
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "classes", "com" ,"subadquirencia", "GXcfg.class"))
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "classes", "com" ,"subadquirencia", "GXApplication.class"))
NaoIncluir.append(os.path.join(diretorioApp, "WEB-INF", "PDFReport.ini"))
