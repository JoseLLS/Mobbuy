...
/****** Object:  StoredProcedure [dbo].[ConcResultadosLoop]    Script Date: 04/12/2023 09:50:47 ******/
SET ANSI_NULLS ON
GO
...
CASE 
	...
	WHEN A.ValorVlrPag IS NULL AND B.ValorArqDet IS NULL  AND C.ValorReceberPrv = D.ValorReceberRel THEN 'OK'
	WHEN A.ValorVlrPag = B.ValorArqDet AND C.ValorReceberPrv IS NULL AND D.ValorReceberRel IS NULL THEN 'OK'
