...
/****** Object:  View [dbo].[VwMovTrn]    Script Date: 04/02/2025 14:08:30 ******/
SET ANSI_NULLS ON
GO
...
GROUP BY A.MovTrnId, A.MovTrnDta, A.MovTrnNsu, A.MovTrnAutCod, A.MovTrnVlr, A.MovTrnNsuMovOri, D.TblBanSigla, D.TblBanBandeira,
		 ...
		 A.MovTrnTxaAntPrv, A.MovtrnAnt, A.MovTrnVanSeq, A.MovTrnTxCobrancaId, A.MovTrnNumCar, G.VanTrnCupFis
GO
